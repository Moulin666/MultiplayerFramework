    ...
    public class Stat : DomainBase
    {
        ...
        public int Value
        {
            ...
            set
            {
                ...
                if (this.value != value) { this.value = value; PropertyHasChanged(nameof(Value)); }
            }
        }
        ...
        {
            return String.Format(CultureInfo.CurrentCulture, "{0}: {1} - {3} ({2})", this.GetType(), name, id, value);
        }
