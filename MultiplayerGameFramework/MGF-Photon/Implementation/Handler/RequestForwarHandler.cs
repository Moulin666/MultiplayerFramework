...
{
	public class RequestForwarHandler : ServerHandler, IDefaultRequestHandler<IServerPeer>
	{
		...
		public RequestForwarHandler(ILogger log, IConnectionCollection<IClientPeer> connectionCollection, ServerConfiguration serverConfiguration)
		{
			Log = log;
